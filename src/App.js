  ...
  return (
    <div className="App">
      <div className=" container container-fluid">
        ...
        <a className="btn well " href="https://books.zuri.team/" id="books">
          {" "}
          Zuri Books
        </a>
        ...
        <a
          className="btn well "
          href="https://books.zuri.team/python-for-beginners?ref_id=smartpyj"
          id="book_python"
        >
          Python Books{" "}
        </a>
